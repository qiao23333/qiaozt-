...
export const siteConfig: SiteConfig = {
	...
	// 站点描述
	description:
		"乌鹊南飞 —— 我的公开个人世界。记录我做过的事、正在思考的问题、积累的作品与知识，以及一步步构建自己世界的过程。",

	// 站点关键词
	keywords: ["乌鹊南飞", "个人站", "作品集", "博客", "内容运营", "AI 工具", "技术", "写作"],
	...
	pagination: {
		// 每页显示的文章数量
		// 当前公开文章数量不足以形成第二页时，保持首页完整展示，避免出现只剩一篇的孤立分页。
		postsPerPage: 12,
	},
