...
export const site = {
  name: "乌鹊南飞",
  desc: "月明星稀，乌鹊南飞",
  url: "https://your-site.example", /* TODO: 部署后替换为正式域名 */
  avatar: "https://github.com/qiao23333.png",
  screenshot: "https://your-site.example/index.png", /* TODO: 部署后替换 */
  email: "1162393961@qq.com",
};
      ...
      <div class="p-5 sm:p-6 flex flex-col flex-1">
        ...
        <div class="space-y-2.5 flex-1">
          {[
            ...
            { label: "主页截图", value: site.screenshot },
          ].map((item) => (
        ...
        <div class="space-y-0 flex-1">
          ...
          <div class="flex gap-3.5">
            ...
            <div class="pb-4">
              ...
              <p class="mt-1 text-xs text-(--primary) leading-relaxed">建议直接按照申请模板填写后发到评论区，已嵌入 AI 自动审核了哦，通过后会自动添加的~</p>
            </div>
          </div>
