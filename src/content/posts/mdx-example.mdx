...
aiSummary: 这篇示例对比 Markdown 与 MDX 的能力边界，并用 import、JSX 组件和导出变量展示如何在文章里加入动态内容。
...
:::tip
[Rain](https://github.com/CuteLeaf/Firefly) 支持 `MDX` 和 `Markdown` 两种类型的文章，你可以在文章中混合使用两种格式，如果没有特别复杂内容和需求，推荐使用 Markdown 格式就够了。
:::
