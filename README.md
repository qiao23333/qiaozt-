...
🚀 快速指南：
[**🖥️在线预览**](http://rainzt.cn/) /
[**📝使用文档**](https://docs-rainzt.cn/) /
...
>
>**更多布局配置及演示请查看：[Firefly 布局系统详解](http://rainzt.cn/posts/firefly-layout-system/)**
>
...
> 📚 **详细配置文档**: 查看 [Firefly使用文档](https://docs-rainzt.cn/) 获取完整的配置指南
...
- 提醒块（Admonitions） - 支持 GitHub, Obsidian, VitePress, Docusaurus 四种风格主题配置 ([预览和用法](http://rainzt.cn/posts/markdown-extended/))
- GitHub 仓库卡片 ([预览和用法](http://rainzt.cn/posts/markdown-extended/))
- 基于 Expressive Code 的增强代码块 ([预览](http://rainzt.cn/posts/code-examples/) / [文档](https://expressive-code.com/))
